  ...
  return (
    <section className="max-container">
      ...
      <div className="py-16">
        ...
        <div className="mt-5 flex flex-col gap-3 text-slate-500">
          <p>I've worked with all sorts companies, leveling up my skills and teaming up with smart people. Here's the rundown:</p>
        </div>
              ...
              >
                ...
                <ul className="my-5 list-disc ml-5 space-y-2">
                  {experience.points.map((point, index) => (
                    <li key={`experience-point-${index}`} className="text-black-500 font-nomal pl-1 text-sm">
                      {point}
                    </li>
                  ))}
                </ul>
