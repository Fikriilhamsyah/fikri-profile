...
const Contact = () => {
  ...
  const [curretnAnimation, setCurretnAnimation] = useState('idle');
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      ...
      import.meta.env.VITE_APP_EMAILJS_TEMPLATE_ID,
      {
        ...
        to_email: "fikriilhamsyah27@gmail.com",
  ...
  const handleFocus = () => setCurretnAnimation('walk');
  const handleBlur = () => setCurretnAnimation('idle');
      ...
      <div className="lg:w-1/2 w-full lg:h-auto md:h-[550px] h-[350px]">
        ...
        >
          ...
          <Suspense fallback={<Loader />}>
            <Fox
              currentAnimation={curretnAnimation}
              position={[0.5, 0.35, 0]}
              rotation={[12.6, -0.6, 0]}
              scale={[0.5, 0.5, 0.5]}
            />
